...
Build and publish a shared, pinned `ltex-cli-plus` image so consuming
repos' CI pulls it instead of each downloading and unpacking the 319 MB
LTeX tarball independently, and keep the pin and the repo itself current.
