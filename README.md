...
- [alrayyes/server-dotfiles](https://git.higherlearning.eu/alrayyes/server-dotfiles) ([#160](https://git.higherlearning.eu/alrayyes/server-dotfiles/issues/160))
- [alrayyes/claude-dotfiles](https://git.higherlearning.eu/alrayyes/claude-dotfiles) ([#166](https://git.higherlearning.eu/alrayyes/claude-dotfiles/issues/166))
